...
const icons = { dashboard:'⌂', order:'+', orders:'▤', summary:'◔', inventory:'▥', tables:'▦', kitchen:'◫', logout:'↪' };
const primary = [
...
export default function AppShell({children}){
 const pathname=usePathname();const router=useRouter();const isActive=item=>item.match?pathname===item.href||pathname.startsWith(item.match):pathname===item.href;
